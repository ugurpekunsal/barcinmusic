!(function (e) {
	...
	function n(e, n, i) {
		"addEventListener" in window
			...
			: "attachEvent" in window && e.attachEvent("on" + n, i);
	}
	function i(e, n, i) {
		"removeEventListener" in window
			? e.removeEventListener(n, i, !1)
			: "detachEvent" in window && e.detachEvent("on" + n, i);
	}
	function t() {
		var e,
			n = ["moz", "webkit", "o", "ms"];
		for (e = 0; e < n.length && !A; e += 1)
			A = window[n[e] + "RequestAnimationFrame"];
	...
	function s(e) {
		...
		function u(e) {
			var n = Number(q[X]["max" + e]),
				...
				t = e.toLowerCase(),
				o = Number(Q[t]);
			r(X, "Checking " + t + " is in range " + i + "-" + n),
				i > o && ((o = i), r(X, "Set " + t + " to min value")),
				o > n && ((o = n), r(X, "Set " + t + " to max value")),
				(Q[t] = "" + o);
		}
		function s() {
			function n() {
				function e() {
					var e = 0,
						n = !1;
					for (
						r(X, "Checking connection is from allowed list of origins: " + t);
						e < t.length;
						e++
					)
						if (t[e] === i) {
		...
		function x(e) {
			r(
				...
				A("messageCallback", { iframe: Q.iframe, message: JSON.parse(e) }),
				r(X, "--");
		}
		function z() {
		...
		function C() {
			q[X] &&
				q[X].stopPageInfo &&
				(q[X].stopPageInfo(), delete q[X].stopPageInfo);
		}
		function E() {
			var e = !0;
			return (
				null === Q.iframe &&
					(c(X, "IFrame (" + Q.id + ") not found"), (e = !1)),
				e
			);
		}
		function T(e) {
		...
		function O(e) {
			...
			r(
				X,
				"Reposition requested from iFrame (offset x:" + o.x + " y:" + o.y + ")"
			),
				window.top !== window.self ? t() : n();
		}
		function W() {
		...
		function N(e) {
			function n() {
				var e = T(a);
				r(X, "Moving to in page link (#" + t + ") at x: " + e.x + " y: " + e.y),
					(j = { x: e.x, y: e.y }),
					W(),
					r(X, "--");
			}
		...
		function L() {
			switch ((q[X] && q[X].firstRun && D(), Q.type)) {
				case "close":
					q[X].closeRequestCallback
						? f(X, "closeRequestCallback", q[X].iframe)
						: d(Q.iframe);
					break;
				case "message":
					x(F(6));
		...
		function B(e) {
			...
			return (
				q[e] ||
					((n = !1),
					c(Q.type + " No settings for " + e + ". Message was: " + J)),
				n
			);
		}
		function U() {
			for (var e in q)
				p("iFrame requested init", y(e), document.getElementById(e), e);
		}
		function D() {
			q[X] && (q[X].firstRun = !1);
		}
	...
	function h(e) {
		function n(n) {
			(e.iframe.style[n] = e[n] + "px"),
				r(e.id, "IFrame (" + o + ") " + n + " set to " + e[n] + "px");
		}
		function i(n) {
			W ||
				"0" !== e[n] ||
				((W = !0),
				r(o, "Hidden iFrame detected, creating visibility listener"),
				M());
		}
		function t(e) {
			n(e), i(e);
	...
	function p(e, n, i, t, o) {
		function a() {
			...
			r(
				...
				i.contentWindow.postMessage(H + n, o);
		}
		function u() {
	...
	function v(i, t) {
		...
		function c(e) {
			return (
				...
				"" === e &&
					...
					(O = (t || {}).log),
					(V = e),
					r(e, "Added missing iframe ID: " + e + " (" + i.src + ")")),
				e
			);
		}
		function u() {
			switch (
				(r(
					k,
					"IFrame scrolling " +
						(q[k] && q[k].scrolling ? "enabled" : "disabled") +
						" for " +
						k
				),
				(i.style.overflow =
					!1 === (q[k] && q[k].scrolling) ? "hidden" : "auto"),
				q[k] && q[k].scrolling)
			) {
				case !0:
					i.scrolling = "yes";
		...
		function s() {
			("number" == typeof (q[k] && q[k].bodyMargin) ||
				"0" === (q[k] && q[k].bodyMargin)) &&
				((q[k].bodyMarginV1 = q[k].bodyMargin),
				(q[k].bodyMargin = "" + q[k].bodyMargin + "px"));
		}
		function f() {
			...
			Function.prototype.bind &&
				...
				(q[k].iframe.iFrameResizer = {
					...
					sendMessage: function (e) {
						(e = JSON.stringify(e)),
							p("Send Message", "message:" + e, q[k].iframe, k);
					},
				});
		}
		function m(t) {
		...
		function h(e) {
			for (var n in U)
				U.hasOwnProperty(n) && (q[k][n] = e.hasOwnProperty(n) ? e[n] : U[n]);
		}
		function b(e) {
			return "" === e || "file://" === e ? "*" : e;
		}
		function v(e) {
			(e = e || {}),
				...
				q[k] &&
					(q[k].targetOrigin =
						!0 === q[k].checkOrigin ? b(q[k].remoteHost) : "*");
		}
		var k = c(i.id);
		v(t), u(), o(), s(), m(y(k)), l();
	}
		...
		function e() {
			function e(e) {
				...
				q[e] &&
					i(q[e].iframe) &&
					(n("height") || n("width")) &&
					p("Visibility change", "resize", q[e].iframe, e);
			}
			for (var n in q) e(n);
		}
		function n(n) {
			r("window", "Mutation observed: " + n[0].target + " " + n[0].type),
				k(e, 16);
		}
		function i() {
	...
	function x() {
		...
		"hidden" !== document.visibilityState &&
			(r("document", "Trigger event: Visiblity change"), k(e, 16));
	}
	function z(e, n) {
		function i(e) {
			return (
				q[e] &&
				"parent" === q[e].resizeFrom &&
				q[e].autoResize &&
				!q[e].firstRun
			);
		}
	...
	if ("undefined" != typeof window) {
		...
		window.jQuery && E(window.jQuery),
			(window.iFrameResize = window.iFrameResize || C());
	}
})();
